...
int main(int argc, char * argv[])
{
...

    {
...

        {
            ...
            short_path::graph_node_ptr_t r = graph_main.create_node("r");
            short_path::graph_node_ptr_t s = graph_main.create_node("s");
            short_path::graph_node_ptr_t t = graph_main.create_node("t");
            short_path::graph_node_ptr_t u = graph_main.create_node("u");
            short_path::graph_node_ptr_t v = graph_main.create_node("v");
            short_path::graph_node_ptr_t w = graph_main.create_node("w");
